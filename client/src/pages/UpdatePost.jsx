  ...
  return (
    <div className="max-w-3xl min-h-screen p-3 mx-auto">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        <ReactQuill theme="snow" placeholder="Write someting....." className="mb-12 h-72" required  onChange={(value)=>setFormData({...formData, content:value})} value={formData.content}/>
