    ...
    <div className='flex flex-col md:flex-row'>
      <div className='border-b border-gray-500 p-7 md:border-r md:min-h-screen'>
        <form className='flex flex-col gap-2' onSubmit={handleSubmit}>
          ...
          <div className='flex items-center gap-2 mb-4'>
              <label className='font-semibold'>Categoty:</label>
      ...
      <div className='w-full'>
        <h1 className='p-3 mt-5 text-3xl font-semibold border-gray-500 sm:border-b'>Post Results:</h1>
        <div className='flex flex-wrap gap-4 p-7'>
          ...
          {
            showMore && <button onClick={handleShowMore} className='w-full text-lg text-teal-500 hover:underline'>Show More</button>
          }
        </div>
      </div>
    </div>
